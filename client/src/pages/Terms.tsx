        ...
        <div className="space-y-6 text-sm leading-relaxed text-foreground">
          <section>
            ...
            <p className="text-muted-foreground">
              이 약관은 조작 로또번호 분석 (타이거마스크, 이하 "서비스")이 제공하는 서비스의 이용과 관련하여 서비스와 이용자의 권리, 의무 및 책임 사항을 규정함을 목적으로 합니다.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3 text-muted-foreground">
              "조작"이라는 서비스명은 운영자(타이거마스크)가 번호를 직접 선별·배분하는 방식을 의미하며, 복권 당첨을 조작하거나 보장하는 서비스가 아닙니다. 본 서비스는 실제 복권 판매 및 베팅을 제공하지 않습니다.
            </p>
          </section>
